...
def create_botxuser_table() -> None:
    op.create_table(
        "botxuser",
...
def create_botxchat_table() -> None:
    op.create_table(
        "botxchat",
...
def create_chat_admins_table() -> None:
    op.create_table(
        "chat_user_admins",
        sa.Column(
            "botxchat_id",
...
def create_chat_members_table() -> None:
    op.create_table(
        "chat_user_members",
        sa.Column(
            "botxchat_id",
